    ...
    <div className="allpost-container">
      ...
      <div style={{ display: "flex" ,marginTop: "70px"}}>
        ...
        <div style={{ display: "flex", width: "100%", paddingLeft: "150px",paddingRight:"150px" }}>
          <div style={{ width: "100%" }}> <ArticleCard onUpdate={handleUpdate} isAuth={isAuth} newArticle={newArticle || updatedArticle} searchQuery={searchQuery} setSearchQuery={setSearchQuery} /></div>
